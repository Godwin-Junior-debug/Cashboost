...
const SUPPORT_EMAIL = 'supportcashboost9ja@gmail.com';
const WHATSAPP_NUMBER = '2349151352263'; // full intl format, no + or leading zeros
const TELEGRAM_HANDLE = 'cashboost9ja';
  ...
  const channels = [
    {
      ...
      primaryAction: {
        ...
        href: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
          'Hi, I need help with my Cashboost9ja account.'
        )}`,
      },
