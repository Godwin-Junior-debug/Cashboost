# DailyCash9ja — Local setup for auth & database

This project uses Supabase for auth and as the primary database. The frontend expects the `profiles` table and related schema defined in `supabase/migrations/20260711115344_create_dailycash9ja_schema.sql`.
...
- Open your Supabase project, go to **SQL Editor**, create a new query, paste the contents of `supabase/migrations/20260711115344_create_dailycash9ja_schema.sql`, and run it.
...
```bash
psql "postgres://..." -f supabase/migrations/20260711115344_create_dailycash9ja_schema.sql
```
